...
science_sidereal_target = {
    ...
    "recipe": ["kpf_common_parameters", "kpf_acq", "kpf_sci", "sidereal_target"]}

science_non_sidereal_target = {
    "metadata": {
    ...
    "recipe": ["kpf_common_parameters", "kpf_acq", "kpf_sci", "non_sideriel_target"]}
...
science_kpf_target = {
    ...
    "recipe": ["kpf_common_parameters", "kpf_acq", "kpf_sci", "kpf_target"]}
...
calibration_dark = {
    ...
    "recipe": ["kpf_common_parameters", "kpf_dark"]}
...
calibration_arcs = {
    ...
    "recipe": ["kpf_common_parameters", "kpf_arcs"]
}
